...
def embedding_attention_seq2seq(encoder_inputs,
  ...
  with variable_scope.variable_scope(
    ...
    # Encoder.
    encoder_cell = copy.deepcopy(cell)
    encoder1_cell = copy.deepcopy(cell)
    # encoder_cell = core_rnn_cell.EmbeddingWrapper(
    #     encoder_cell,
    #     embedding_classes=num_encoder_symbols,
    #     embedding_size=embedding_size)
    ...
    encoder_outputs, encoder_state = core_rnn.static_rnn(
        encoder_cell, encoder_inputs, dtype=dtype,scope='encoder_rnn')
    encoder1_outputs,encoder1_state = core_rnn.static_rnn(
        encoder1_cell,encoder1_inputs,dtype=dtype,scope='encoder1_rnn')
    # First calculate a concatenation of encoder outputs to put attention on.
    top_states = [
        array_ops.reshape(e, [-1, 1, cell.output_size]) for e in encoder_outputs+encoder1_outputs
    ]
...
def model_with_buckets(encoder_inputs,
  ...
  all_inputs = encoder_inputs + encoder1_inputs, decoder_inputs + targets + weights
