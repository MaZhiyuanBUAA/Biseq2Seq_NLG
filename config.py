...
tf.app.flags.DEFINE_string('model_dir', 'models', 'Train directory')
tf.app.flags.DEFINE_string('results_dir', 'results', 'Train directory')
tf.app.flags.DEFINE_string('emb_path','models/embeddings.pkl','Embeddings')
...
tf.app.flags.DEFINE_integer('max_train_data_size', 100000, 'Limit on the size of training data (0: no limit).')
