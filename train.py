...
def train():
    ...
    with tf.Session() as sess:
        ...
        while model.global_step.eval()<max_global_step:
          ...
          _, step_loss, _ = model.step(sess, encoder_inputs, encoder1_inputs,decoder_inputs,
          ...
          if current_step % FLAGS.steps_per_checkpoint == 0:
            ...
            for bucket_id in xrange(len(BUCKETS)):
              encoder_inputs, encoder1_inputs, decoder_inputs, target_weights = model.get_batch(dev_set, bucket_id)
              _, eval_loss, _ = model.step(sess, encoder_inputs, encoder1_inputs,decoder_inputs, target_weights, bucket_id, True)
